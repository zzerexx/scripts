-- Universal Chams w/ Custom Color
-- Made by zzerexx#3970
getgenv().color = Color3.new(0, 255, 246)
...
for i,v in pairs(game.Workspace:GetDescendants()) do
    ...
    if v.ClassName == "Humanoid" then
        if v.RigType == Enum.HumanoidRigType.R15 then
            ...
            rlowerleg.Color3 = getgenv().color
            ...
            rupperleg.Color3 = getgenv().color
            ...
            rlowerarm.Color3 = getgenv().color
            ...
            rupperarm.Color3 = getgenv().color
            ...
            llowerleg.Color3 = getgenv().color
            ...
            lupperleg.Color3 = getgenv().color
            ...
            llowerarm.Color3 = getgenv().color
            ...
            lupperarm.Color3 = getgenv().color
            ...
            uppertorso.Color3 = getgenv().color
